  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="relative z-10 mx-auto flex max-w-7xl flex-col items-center px-6 pt-16 pb-20 text-center">
        {/* Scoped to just the title/calculator/categories block (not Stats below) — HeroMathDoodles
            is absolutely positioned within this wrapper only, so it never bleeds into the stats row. */}
