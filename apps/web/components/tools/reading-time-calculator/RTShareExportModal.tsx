...
export default function RTShareExportModal({ operationLabel, inputRows, resultRows, heroLabel, heroValue, sentence }: RTShareExportModalProps) {
  ...
  async function handleDownloadPdf() {
    ...
    try {
      await generateToolPdf({
        ...
        filename: "reading-time-calculator.pdf",
      });
      setPdfState("done");
