...
type BarcodeShareExportModalProps = {
...
export default function BarcodeShareExportModal({ operationLabel, inputRows, resultRows, heroLabel, heroValue, sentence }: BarcodeShareExportModalProps) {
  ...
  async function handleDownloadPdf() {
    ...
    try {
      await generateToolPdf({
        ...
        filename: "barcode-generator.pdf",
      });
      setPdfState("done");
