...
import { Base64Tool, type Base64Mode } from "@tooloralabs/tools";
import ToolButton from "@/components/tool-ui/ToolButton";

const tool = new Base64Tool();

export default function Base64ToolUI() {
  ...
  return (
    <div className="space-y-6 rounded-3xl border border-zinc-200 bg-white p-8 shadow-sm dark:border-zinc-800 dark:bg-zinc-900 dark:shadow-none">
      ...
      <div className="flex flex-wrap gap-4">
        <ToolButton type="button" onClick={() => run("encode")}>
          {t("form.encode")}
        </ToolButton>
        <button
          type="button"
