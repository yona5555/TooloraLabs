...
type Base64ShareExportModalProps = {
...
export default function Base64ShareExportModal({ operationLabel, inputRows, resultRows, heroLabel, heroValue, sentence }: Base64ShareExportModalProps) {
