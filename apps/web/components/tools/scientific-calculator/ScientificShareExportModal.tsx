...
type ScientificShareExportModalProps = {
...
export default function ScientificShareExportModal({ operationLabel, inputRows, resultRows, heroLabel, heroValue, sentence }: ScientificShareExportModalProps) {
