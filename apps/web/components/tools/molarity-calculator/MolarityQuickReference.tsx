...
const FORMULA_KEYS = ["molarity", "molesFromMass", "dilution"] as const;

export default function MolarityQuickReference() {
  const t = useTranslations("tools.molarity-calculator.aboveFold.quickReference");
