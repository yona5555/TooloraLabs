...
type MolarityShareExportModalProps = {
...
export default function MolarityShareExportModal({ operationLabel, inputRows, resultRows, heroLabel, heroValue, sentence, gauge }: MolarityShareExportModalProps) {
  ...
  async function handleDownloadPdf() {
    ...
    try {
      await generateToolPdf({
        ...
        filename: "molarity-calculator.pdf",
      });
      setPdfState("done");
