...
type DuplicateLineShareExportModalProps = {
...
export default function DuplicateLineShareExportModal({ operationLabel, inputRows, resultRows, heroLabel, heroValue, sentence }: DuplicateLineShareExportModalProps) {
  ...
  async function handleDownloadPdf() {
    ...
    try {
      await generateToolPdf({
        ...
        filename: "duplicate-line-remover.pdf",
      });
      setPdfState("done");
