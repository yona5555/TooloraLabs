...
type PregnancyShareExportModalProps = {
  inputRows: Row[];
  resultRows: Row[];
  heroLabel: string;
  heroValue: string;
...
export default function PregnancyShareExportModal({ inputRows, resultRows, heroLabel, heroValue, sentence, gauge }: PregnancyShareExportModalProps) {
  ...
  async function handleDownloadPdf() {
    ...
    try {
      await generateToolPdf({
        ...
        filename: "pregnancy-calculator.pdf",
      });
      setPdfState("done");
