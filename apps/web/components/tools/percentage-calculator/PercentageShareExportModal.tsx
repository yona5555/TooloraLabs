...
type PercentageShareExportModalProps = {
  inputRows: Row[];
  resultRows: Row[];
  heroLabel: string;
  heroValue: string;
...
export default function PercentageShareExportModal({ inputRows, resultRows, heroLabel, heroValue, sentence, gauge }: PercentageShareExportModalProps) {
  ...
  async function handleDownloadPdf() {
    ...
    try {
      await generateToolPdf({
        ...
        filename: "percentage-calculator.pdf",
      });
      setPdfState("done");
