...
export default async function BatchInvoiceEducation() {
  ...
  return (
    <EncyclopediaPaper>
      ...
      <InfoSection id="behind-the-tool" title={t("behindTheTool.title")}>
        ...
        <div>
          <h3 className="font-semibold">{t("behindTheTool.dataPrivacy.title")}</h3>
          <p className="mt-2">{t("behindTheTool.dataPrivacy.paragraph")}</p>
        </div>
        <AcademicPathSection
