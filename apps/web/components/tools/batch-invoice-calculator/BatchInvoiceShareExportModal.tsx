...
type BatchInvoiceShareExportModalProps = {
...
export default function BatchInvoiceShareExportModal({ operationLabel, inputRows, resultRows, heroLabel, heroValue, sentence }: BatchInvoiceShareExportModalProps) {
  ...
  async function handleDownloadPdf() {
    ...
    try {
      await generateToolPdf({
        ...
        filename: "batch-invoice-calculator.pdf",
      });
      setPdfState("done");
