...
type DateShareExportModalProps = {
  inputRows: Row[];
  resultRows: Row[];
  heroLabel: string;
  heroValue: string;
...
export default function DateShareExportModal({ inputRows, resultRows, heroLabel, heroValue, sentence, gauge }: DateShareExportModalProps) {
