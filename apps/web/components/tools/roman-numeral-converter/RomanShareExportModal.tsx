...
type RomanShareExportModalProps = {
...
export default function RomanShareExportModal({ operationLabel, inputRows, resultRows, heroLabel, heroValue, sentence }: RomanShareExportModalProps) {
  ...
  async function handleDownloadPdf() {
    ...
    try {
      await generateToolPdf({
        ...
        filename: "roman-numeral-converter.pdf",
      });
      setPdfState("done");
