...
import MortgageSidebarSearch from "./MortgageSidebarSearch";

const CURRENT_SLUG = "mortgage-calculator";
const CATEGORY = "calculators";

export default function MortgageRelatedSidebar() {
  const tTools = useTranslations("tools");
  const tMortgage = useTranslations("tools.mortgage-calculator.aboveFold");
