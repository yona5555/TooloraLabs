...
type OhmsLawShareExportModalProps = {
...
export default function OhmsLawShareExportModal({ operationLabel, inputRows, resultRows, heroLabel, heroValue, sentence, gauge }: OhmsLawShareExportModalProps) {
  ...
  async function handleDownloadPdf() {
    ...
    try {
      await generateToolPdf({
        ...
        filename: "ohms-law-calculator.pdf",
      });
      setPdfState("done");
