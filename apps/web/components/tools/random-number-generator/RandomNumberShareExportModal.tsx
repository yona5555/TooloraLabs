...
type RandomNumberShareExportModalProps = {
...
export default function RandomNumberShareExportModal({ operationLabel, inputRows, resultRows, heroLabel, heroValue, sentence }: RandomNumberShareExportModalProps) {
  ...
  async function handleDownloadPdf() {
    ...
    try {
      await generateToolPdf({
        ...
        filename: "random-number-generator.pdf",
      });
      setPdfState("done");
