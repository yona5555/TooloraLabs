          ...
          <table className="w-full min-w-[420px] border-collapse text-sm">
            <thead>
              <tr className="border-b border-current/30 text-start">
                <th className="px-3 py-2 text-start font-semibold">{t("examples.columnUseCase")}</th>
                <th className="px-3 py-2 text-start font-semibold">{t("examples.columnSettings")}</th>
              </tr>
            </thead>
            <tbody>
              {exampleRows.map((row) => (
