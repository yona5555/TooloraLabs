...
const FORMULA_KEYS = ["determinant", "inverse", "product"] as const;

export default function MatrixQuickReference() {
  const t = useTranslations("tools.matrix-calculator.aboveFold.quickReference");
