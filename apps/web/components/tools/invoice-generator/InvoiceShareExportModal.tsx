...
type InvoiceShareExportModalProps = {
  inputRows: Row[];
  resultRows: Row[];
  heroLabel: string;
  heroValue: string;
...
export default function InvoiceShareExportModal({ inputRows, resultRows, heroLabel, heroValue, sentence, onPrint }: InvoiceShareExportModalProps) {
