...
type BodyFatShareExportModalProps = {
  inputRows: Row[];
  resultRows: Row[];
  heroLabel: string;
  heroValue: string;
...
export default function BodyFatShareExportModal({ inputRows, resultRows, heroLabel, heroValue, sentence, gauge }: BodyFatShareExportModalProps) {
  ...
  async function handleDownloadPdf() {
    ...
    try {
      await generateToolPdf({
        ...
        filename: "body-fat-calculator.pdf",
      });
      setPdfState("done");
