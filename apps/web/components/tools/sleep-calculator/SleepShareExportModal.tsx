...
type SleepShareExportModalProps = {
  inputRows: Row[];
  resultRows: Row[];
  heroLabel: string;
  heroValue: string;
...
export default function SleepShareExportModal({ inputRows, resultRows, heroLabel, heroValue, sentence, gauge }: SleepShareExportModalProps) {
