...
const FORMULA_KEYS = ["work", "kineticEnergy", "potentialEnergy", "power"] as const;

export default function EnergyQuickReference() {
  const t = useTranslations("tools.energy-work-power-calculator.aboveFold.quickReference");
