...
type EnergyShareExportModalProps = {
...
export default function EnergyShareExportModal({ operationLabel, inputRows, resultRows, heroLabel, heroValue, sentence, gauge }: EnergyShareExportModalProps) {
  ...
  async function handleDownloadPdf() {
    ...
    try {
      await generateToolPdf({
        ...
        filename: "energy-work-power-calculator.pdf",
      });
      setPdfState("done");
