...
type LoremShareExportModalProps = {
  inputRows: Row[];
  resultRows: Row[];
  heroLabel: string;
  heroValue: string;
...
export default function LoremShareExportModal({ inputRows, resultRows, heroLabel, heroValue, sentence }: LoremShareExportModalProps) {
  ...
  async function handleDownloadPdf() {
    ...
    try {
      await generateToolPdf({
        ...
        filename: "lorem-ipsum-generator.pdf",
      });
      setPdfState("done");
