...
type SalesTaxShareExportModalProps = {
  modeLabel: string;
  inputRows: Row[];
  resultRows: Row[];
  heroLabel: string;
...
export default function SalesTaxShareExportModal({ modeLabel, inputRows, resultRows, heroLabel, heroValue, sentence }: SalesTaxShareExportModalProps) {
