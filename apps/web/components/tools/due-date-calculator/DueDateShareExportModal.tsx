...
type DueDateShareExportModalProps = {
  inputRows: Row[];
  resultRows: Row[];
  heroLabel: string;
  heroValue: string;
...
export default function DueDateShareExportModal({ inputRows, resultRows, heroLabel, heroValue, sentence, gauge }: DueDateShareExportModalProps) {
  ...
  async function handleDownloadPdf() {
    ...
    try {
      await generateToolPdf({
        ...
        filename: "due-date-calculator.pdf",
      });
      setPdfState("done");
