...
type CitationShareExportModalProps = {
...
export default function CitationShareExportModal({ operationLabel, inputRows, resultRows, heroLabel, heroValue, sentence }: CitationShareExportModalProps) {
  ...
  async function handleDownloadPdf() {
    ...
    try {
      await generateToolPdf({
        ...
        filename: "citation-generator.pdf",
      });
      setPdfState("done");
