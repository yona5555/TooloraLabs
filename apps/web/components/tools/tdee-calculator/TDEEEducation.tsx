    ...
    <EncyclopediaPaper>
      <InfoSection title={t("intro.title")}>
        ...
        <EnergyBalanceDiagram
          caloriesInLabel={t("intro.diagram.caloriesIn")}
          caloriesOutLabel={t("intro.diagram.caloriesOut")}
          ...
          <table className="w-full min-w-[480px] border-collapse text-sm">
            <thead>
              <tr className="border-b border-current/30 text-start">
                <th className="px-3 py-2 text-start font-semibold">{t("examples.columnProfile")}</th>
                <th className="px-3 py-2 text-start font-semibold">{t("examples.columnBmr")}</th>
                <th className="px-3 py-2 text-start font-semibold">{t("examples.columnTdee")}</th>
              </tr>
            </thead>
            <tbody>
              {exampleRows.map((row) => (
                <tr key={row.profile} className="border-b border-current/10">
                  <td className="px-3 py-2.5">{row.profile}</td>
                  <td className="px-3 py-2.5 font-mono">{row.bmr}</td>
                  <td className="px-3 py-2.5 font-mono font-semibold">{row.tdee}</td>
                </tr>
              ))}
            </tbody>
          </table>
