...
type TDEEShareExportModalProps = {
  inputRows: Row[];
  resultRows: Row[];
  heroLabel: string;
  heroValue: string;
...
export default function TDEEShareExportModal({ inputRows, resultRows, heroLabel, heroValue, sentence, gauge }: TDEEShareExportModalProps) {
