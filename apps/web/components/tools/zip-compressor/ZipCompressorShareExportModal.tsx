...
type ZipCompressorShareExportModalProps = {
  inputRows: Row[];
  resultRows: Row[];
  heroLabel: string;
  heroValue: string;
...
export default function ZipCompressorShareExportModal({ inputRows, resultRows, heroLabel, heroValue, sentence }: ZipCompressorShareExportModalProps) {
