...
type OvulationShareExportModalProps = {
  inputRows: Row[];
  resultRows: Row[];
  heroLabel: string;
  heroValue: string;
...
export default function OvulationShareExportModal({ inputRows, resultRows, heroLabel, heroValue, sentence, gauge }: OvulationShareExportModalProps) {
  ...
  async function handleDownloadPdf() {
    ...
    try {
      await generateToolPdf({
        ...
        filename: "ovulation-calculator.pdf",
      });
      setPdfState("done");
