...
type CommodityShareExportModalProps = {
...
export default function CommodityShareExportModal({ operationLabel, inputRows, resultRows, heroLabel, heroValue, sentence }: CommodityShareExportModalProps) {
  ...
  async function handleDownloadPdf() {
    ...
    try {
      await generateToolPdf({
        ...
        filename: "commodities-tracker.pdf",
      });
      setPdfState("done");
