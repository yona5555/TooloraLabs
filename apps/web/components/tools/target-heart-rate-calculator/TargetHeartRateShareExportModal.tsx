...
type TargetHeartRateShareExportModalProps = {
  inputRows: Row[];
  resultRows: Row[];
  heroLabel: string;
  heroValue: string;
...
export default function TargetHeartRateShareExportModal({ inputRows, resultRows, heroLabel, heroValue, sentence, gauge }: TargetHeartRateShareExportModalProps) {
  ...
  async function handleDownloadPdf() {
    ...
    try {
      await generateToolPdf({
        ...
        filename: "target-heart-rate-calculator.pdf",
      });
      setPdfState("done");
