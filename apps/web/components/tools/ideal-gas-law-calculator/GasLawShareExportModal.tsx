...
type GasLawShareExportModalProps = {
...
export default function GasLawShareExportModal({ operationLabel, inputRows, resultRows, heroLabel, heroValue, sentence, gauge }: GasLawShareExportModalProps) {
  ...
  async function handleDownloadPdf() {
    ...
    try {
      await generateToolPdf({
        ...
        filename: "ideal-gas-law-calculator.pdf",
      });
      setPdfState("done");
