...
type CsvJsonShareExportModalProps = {
...
export default function CsvJsonShareExportModal({ operationLabel, inputRows, resultRows, heroLabel, heroValue, sentence }: CsvJsonShareExportModalProps) {
  ...
  async function handleDownloadPdf() {
    ...
    try {
      await generateToolPdf({
        ...
        filename: "csv-json-converter.pdf",
      });
      setPdfState("done");
