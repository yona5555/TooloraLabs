...
/**
 * A compact, self-contained variant of the BMI calculator for third-party
 * embedding (iframe). No sidebar, no encyclopedic section, no site chrome —
 * just the input form and the result, stacked in a single narrow column.
 */
export default function BMICalculatorEmbed() {
