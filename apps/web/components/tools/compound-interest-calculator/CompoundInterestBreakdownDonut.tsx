...
type CompoundInterestBreakdownDonutProps = {
  segments: Segment[];
  centerValue: string;
  centerLabel: string;
};
...
export default function CompoundInterestBreakdownDonut({ segments, centerValue, centerLabel }: CompoundInterestBreakdownDonutProps) {
