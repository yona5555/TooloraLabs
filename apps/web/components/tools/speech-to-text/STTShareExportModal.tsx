...
export default function STTShareExportModal({ resultRows, heroLabel, heroValue, sentence }: STTShareExportModalProps) {
  const t = useTranslations("tools.speech-to-text");
