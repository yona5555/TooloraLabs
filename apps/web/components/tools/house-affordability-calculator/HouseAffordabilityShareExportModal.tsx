...
type HouseAffordabilityShareExportModalProps = {
...
export default function HouseAffordabilityShareExportModal({ mode, inputRows, resultRows, heroLabel, heroValue, sentence }: HouseAffordabilityShareExportModalProps) {
  ...
  async function handleDownloadPdf() {
    ...
    try {
      await generateToolPdf({
        ...
        filename: "house-affordability-calculator.pdf",
      });
      setPdfState("done");
