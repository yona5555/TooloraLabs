...
type MolarMassShareExportModalProps = {
...
export default function MolarMassShareExportModal({ operationLabel, inputRows, resultRows, heroLabel, heroValue, sentence, gauge }: MolarMassShareExportModalProps) {
  ...
  async function handleDownloadPdf() {
    ...
    try {
      await generateToolPdf({
        ...
        filename: "molar-mass-calculator.pdf",
      });
      setPdfState("done");
