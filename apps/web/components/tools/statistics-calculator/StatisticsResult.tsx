...
import StatisticsShareExportModal from "./StatisticsShareExportModal";
          ...
          <div className="flex items-center gap-2">
            ...
            <StatisticsShareExportModal
              ...
              resultRows={[
                ...
                { label: t("sampleStdDev"), value: fmt(result.sampleStdDev) },
                { label: t("populationVariance"), value: fmt(result.populationVariance) },
                { label: t("sampleVariance"), value: fmt(result.sampleVariance) },
              ]}
              heroLabel={t("mean")}
