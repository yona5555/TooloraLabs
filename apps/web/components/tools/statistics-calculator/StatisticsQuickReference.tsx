...
const FORMULA_KEYS = ["mean", "median", "populationStdDev", "sampleStdDev"] as const;

export default function StatisticsQuickReference() {
  const t = useTranslations("tools.statistics-calculator.aboveFold.quickReference");
