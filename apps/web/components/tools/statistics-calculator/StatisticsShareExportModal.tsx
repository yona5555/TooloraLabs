...
type StatisticsShareExportModalProps = {
...
export default function StatisticsShareExportModal({ operationLabel, inputRows, resultRows, heroLabel, heroValue, sentence }: StatisticsShareExportModalProps) {
  ...
  async function handleDownloadPdf() {
    ...
    try {
      await generateToolPdf({
        ...
        filename: "statistics-calculator.pdf",
      });
      setPdfState("done");
