...
type PaceShareExportModalProps = {
  inputRows: Row[];
  resultRows: Row[];
  heroLabel: string;
  heroValue: string;
...
export default function PaceShareExportModal({ inputRows, resultRows, heroLabel, heroValue, sentence }: PaceShareExportModalProps) {
