...
type CountdownShareExportModalProps = {
  inputRows: Row[];
  resultRows: Row[];
  heroLabel: string;
  heroValue: string;
...
export default function CountdownShareExportModal({ inputRows, resultRows, heroLabel, heroValue, sentence, gauge }: CountdownShareExportModalProps) {
  const t = useTranslations("tools.countdown-to-event-calculator");
  ...
  async function handleDownloadPdf() {
    ...
    try {
      await generateToolPdf({
        ...
        filename: "countdown-to-event-calculator.pdf",
      });
      setPdfState("done");
