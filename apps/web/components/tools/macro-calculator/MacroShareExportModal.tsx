...
type MacroShareExportModalProps = {
  inputRows: Row[];
  resultRows: Row[];
  heroLabel: string;
  heroValue: string;
...
export default function MacroShareExportModal({ inputRows, resultRows, heroLabel, heroValue, sentence, gauge }: MacroShareExportModalProps) {
