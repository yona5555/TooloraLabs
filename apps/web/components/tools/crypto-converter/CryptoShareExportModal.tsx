...
type CryptoShareExportModalProps = {
...
export default function CryptoShareExportModal({ operationLabel, inputRows, resultRows, heroLabel, heroValue, sentence }: CryptoShareExportModalProps) {
