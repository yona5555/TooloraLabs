...
type SignificantFiguresShareExportModalProps = {
...
export default function SignificantFiguresShareExportModal({ operationLabel, inputRows, resultRows, heroLabel, heroValue, sentence }: SignificantFiguresShareExportModalProps) {
  ...
  async function handleDownloadPdf() {
    ...
    try {
      await generateToolPdf({
        ...
        filename: "significant-figures-calculator.pdf",
      });
      setPdfState("done");
