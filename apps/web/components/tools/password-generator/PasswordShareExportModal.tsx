...
type PasswordShareExportModalProps = {
...
export default function PasswordShareExportModal({ operationLabel, inputRows, resultRows, heroLabel, heroValue, sentence }: PasswordShareExportModalProps) {
  ...
  async function handleDownloadPdf() {
    ...
    try {
      await generateToolPdf({
        ...
        filename: "password-generator.pdf",
      });
      setPdfState("done");
