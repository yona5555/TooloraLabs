...
const FORMULA_KEYS = ["secondLaw", "gravitation", "gravitationalConstant"] as const;

export default function ForceQuickReference() {
  const t = useTranslations("tools.force-calculator.aboveFold.quickReference");
