...
type ForceShareExportModalProps = {
...
export default function ForceShareExportModal({ operationLabel, inputRows, resultRows, heroLabel, heroValue, sentence, gauge }: ForceShareExportModalProps) {
