...
type GcfLcmShareExportModalProps = {
  inputRows: Row[];
  resultRows: Row[];
  heroLabel: string;
  heroValue: string;
...
export default function GcfLcmShareExportModal({ inputRows, resultRows, heroLabel, heroValue, sentence, gauge }: GcfLcmShareExportModalProps) {
  const t = useTranslations("tools.gcf-lcm-calculator");
  ...
  async function handleDownloadPdf() {
    ...
    try {
      await generateToolPdf({
        ...
        filename: "gcf-lcm-calculator.pdf",
      });
      setPdfState("done");
