...
type AffordableLoanShareExportModalProps = {
...
export default function AffordableLoanShareExportModal({ mode, inputRows, resultRows, heroLabel, heroValue, sentence }: AffordableLoanShareExportModalProps) {
  ...
  async function handleDownloadPdf() {
    ...
    try {
      await generateToolPdf({
        ...
        filename: "affordable-loan-calculator.pdf",
      });
      setPdfState("done");
