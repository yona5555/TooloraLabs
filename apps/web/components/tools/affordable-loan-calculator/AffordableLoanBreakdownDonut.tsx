...
type AffordableLoanBreakdownDonutProps = {
  segments: Segment[];
  centerValue: string;
  centerLabel: string;
};
...
export default function AffordableLoanBreakdownDonut({ segments, centerValue, centerLabel }: AffordableLoanBreakdownDonutProps) {
