...
type StudyTimeShareExportModalProps = {
  inputRows: Row[];
  resultRows: Row[];
  heroLabel: string;
  heroValue: string;
...
export default function StudyTimeShareExportModal({ inputRows, resultRows, heroLabel, heroValue, sentence, gauge }: StudyTimeShareExportModalProps) {
  const t = useTranslations("tools.study-time-calculator");
  ...
  async function handleDownloadPdf() {
    ...
    try {
      await generateToolPdf({
        ...
        filename: "study-time-calculator.pdf",
      });
      setPdfState("done");
