...
import TimeDurationScaleGauge from "./TimeDurationScaleGauge";

type ExampleRow = { calculation: string; result: string };
type UseCaseItem = { title: string; description: string };

export default async function TimeEducation() {
  const t = await getTranslations("tools.time-calculator.education");
