...
type TimeShareExportModalProps = {
  inputRows: Row[];
  resultRows: Row[];
  heroLabel: string;
  heroValue: string;
...
export default function TimeShareExportModal({ inputRows, resultRows, heroLabel, heroValue, sentence, gauge }: TimeShareExportModalProps) {
