...
export default function PhShareExportModal({ operationLabel, inputRows, resultRows, heroLabel, heroValue, sentence, gauge }: PhShareExportModalProps) {
  const t = useTranslations("tools.ph-calculator");
