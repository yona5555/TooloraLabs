...
type ScientificNotationShareExportModalProps = {
...
export default function ScientificNotationShareExportModal({ operationLabel, inputRows, resultRows, heroLabel, heroValue, sentence }: ScientificNotationShareExportModalProps) {
  ...
  async function handleDownloadPdf() {
    ...
    try {
      await generateToolPdf({
        ...
        filename: "scientific-notation-converter.pdf",
      });
      setPdfState("done");
