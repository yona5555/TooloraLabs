...
type DiscountShareExportModalProps = {
  modeLabel: string;
  inputRows: Row[];
  resultRows: Row[];
  heroLabel: string;
...
export default function DiscountShareExportModal({ modeLabel, inputRows, resultRows, heroLabel, heroValue, sentence }: DiscountShareExportModalProps) {
  ...
  async function handleDownloadPdf() {
    ...
    try {
      await generateToolPdf({
        ...
        filename: "discount-calculator.pdf",
      });
      setPdfState("done");
