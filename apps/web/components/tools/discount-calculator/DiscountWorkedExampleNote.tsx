...
/** Matches BreakEvenWorkedExampleNote/FuelWorkedExampleNote/TipWorkedExampleNote exactly — the site-wide reference for the label/value list beside a chart. */
export default function DiscountWorkedExampleNote({ title, rows }: Props) {
  return (
