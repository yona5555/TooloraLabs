...
export default function QRShareExportModal({ operationLabel, inputRows, resultRows, heroLabel, heroValue, sentence }: QRShareExportModalProps) {
  ...
  async function handleDownloadPdf() {
    ...
    try {
      await generateToolPdf({
        ...
        filename: "qr-code-generator.pdf",
      });
      setPdfState("done");
