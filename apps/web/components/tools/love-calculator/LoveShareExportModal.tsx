...
type LoveShareExportModalProps = {
  inputRows: Row[];
  resultRows: Row[];
  heroLabel: string;
  heroValue: string;
...
export default function LoveShareExportModal({ inputRows, resultRows, heroLabel, heroValue, sentence, gauge }: LoveShareExportModalProps) {
