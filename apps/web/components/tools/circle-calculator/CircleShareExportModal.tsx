...
type CircleShareExportModalProps = {
  inputRows: Row[];
  resultRows: Row[];
  heroLabel: string;
  heroValue: string;
...
export default function CircleShareExportModal({ inputRows, resultRows, heroLabel, heroValue, sentence, gauge }: CircleShareExportModalProps) {
  ...
  async function handleDownloadPdf() {
    ...
    try {
      await generateToolPdf({
        ...
        filename: "circle-calculator.pdf",
      });
      setPdfState("done");
