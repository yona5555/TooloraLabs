...
type WordCounterShareExportModalProps = {
...
export default function WordCounterShareExportModal({ operationLabel, inputRows, resultRows, heroLabel, heroValue, sentence }: WordCounterShareExportModalProps) {
