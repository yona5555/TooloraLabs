...
type FileSizeConverterShareExportModalProps = {
...
export default function FileSizeConverterShareExportModal({ operationLabel, inputRows, resultRows, heroLabel, heroValue, sentence }: FileSizeConverterShareExportModalProps) {
  ...
  async function handleDownloadPdf() {
    ...
    try {
      await generateToolPdf({
        ...
        filename: "file-size-converter.pdf",
      });
      setPdfState("done");
  ...
  return (
    <>
      ...
      <div data-print-area className="hidden bg-white p-8 text-black print:block">
        ...
        <h2 className="mb-2 mt-6 text-base font-bold text-blue-600">{t("aboveFold.resultTitle")}</h2>
        <table className="w-full border-collapse text-base">
          <tbody>
            <tr>
