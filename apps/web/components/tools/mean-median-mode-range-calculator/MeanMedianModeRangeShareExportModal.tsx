...
type MeanMedianModeRangeShareExportModalProps = {
...
export default function MeanMedianModeRangeShareExportModal({ operationLabel, inputRows, resultRows, heroLabel, heroValue, sentence }: MeanMedianModeRangeShareExportModalProps) {
  const t = useTranslations("tools.mean-median-mode-range-calculator");
  ...
  async function handleDownloadPdf() {
    ...
    try {
      await generateToolPdf({
        ...
        filename: "mean-median-mode-range-calculator.pdf",
      });
      setPdfState("done");
