...
const FORMULA_KEYS = ["velocity", "displacementTime", "velocitySquared", "displacementAvg"] as const;

export default function KinematicsQuickReference() {
  const t = useTranslations("tools.kinematics-calculator.aboveFold.quickReference");
