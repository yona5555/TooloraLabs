...
type KinematicsShareExportModalProps = {
...
export default function KinematicsShareExportModal({ operationLabel, inputRows, resultRows, heroLabel, heroValue, sentence, gauge }: KinematicsShareExportModalProps) {
  const t = useTranslations("tools.kinematics-calculator");
  ...
  async function handleDownloadPdf() {
    ...
    try {
      await generateToolPdf({
        locale,
        toolName: `${t("title")} — ${operationLabel}`,
        inputs: inputRows,
        results: resultRows,
        gauge,
        ...
        filename: "kinematics-calculator.pdf",
      });
      setPdfState("done");
