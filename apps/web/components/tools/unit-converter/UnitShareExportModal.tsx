...
type UnitShareExportModalProps = {
...
export default function UnitShareExportModal({ operationLabel, inputRows, resultRows, heroLabel, heroValue, sentence }: UnitShareExportModalProps) {
