...
type QuoteShareExportModalProps = {
  inputRows: Row[];
  resultRows: Row[];
  heroLabel: string;
  heroValue: string;
...
export default function QuoteShareExportModal({ inputRows, resultRows, heroLabel, heroValue, sentence }: QuoteShareExportModalProps) {
  const t = useTranslations("tools.random-quote-generator");
  ...
  async function handleDownloadPdf() {
    ...
    try {
      await generateToolPdf({
        ...
        filename: "random-quote-generator.pdf",
      });
      setPdfState("done");
