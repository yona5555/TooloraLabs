...
type ColorPaletteShareExportModalProps = {
  inputRows: Row[];
  resultRows: Row[];
  heroLabel: string;
  heroValue: string;
...
export default function ColorPaletteShareExportModal({ inputRows, resultRows, heroLabel, heroValue, sentence }: ColorPaletteShareExportModalProps) {
  ...
  async function handleDownloadPdf() {
    ...
    try {
      await generateToolPdf({
        ...
        filename: "color-palette-generator.pdf",
      });
      setPdfState("done");
