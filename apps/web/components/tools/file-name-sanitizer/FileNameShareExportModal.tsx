...
type FileNameShareExportModalProps = {
...
export default function FileNameShareExportModal({ operationLabel, inputRows, resultRows, heroLabel, heroValue, sentence }: FileNameShareExportModalProps) {
  ...
  async function handleDownloadPdf() {
    ...
    try {
      await generateToolPdf({
        ...
        filename: "file-name-sanitizer.pdf",
      });
      setPdfState("done");
