...
type InventoryShareExportModalProps = {
  inputRows: Row[];
  resultRows: Row[];
  heroLabel: string;
  heroValue: string;
...
export default function InventoryShareExportModal({ inputRows, resultRows, heroLabel, heroValue, sentence }: InventoryShareExportModalProps) {
