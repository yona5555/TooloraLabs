...
type DensityShareExportModalProps = {
...
export default function DensityShareExportModal({ operationLabel, inputRows, resultRows, heroLabel, heroValue, sentence, gauge }: DensityShareExportModalProps) {
  ...
  async function handleDownloadPdf() {
    ...
    try {
      await generateToolPdf({
        ...
        filename: "density-calculator.pdf",
      });
      setPdfState("done");
