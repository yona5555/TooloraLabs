...
type FuelShareExportModalProps = {
  inputRows: Row[];
  resultRows: Row[];
  heroLabel: string;
  heroValue: string;
...
export default function FuelShareExportModal({ inputRows, resultRows, heroLabel, heroValue, sentence, gauge }: FuelShareExportModalProps) {
  ...
  async function handleDownloadPdf() {
    ...
    try {
      await generateToolPdf({
        ...
        filename: "fuel-cost-calculator.pdf",
      });
      setPdfState("done");
