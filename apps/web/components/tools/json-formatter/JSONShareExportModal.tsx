...
type JSONShareExportModalProps = {
...
export default function JSONShareExportModal({ operationLabel, inputRows, resultRows, heroLabel, heroValue, sentence }: JSONShareExportModalProps) {
