...
type StandardDeviationShareExportModalProps = {
  inputRows: Row[];
  resultRows: Row[];
  heroLabel: string;
  heroValue: string;
...
export default function StandardDeviationShareExportModal({ inputRows, resultRows, heroLabel, heroValue, sentence, gauge }: StandardDeviationShareExportModalProps) {
  ...
  async function handleDownloadPdf() {
    ...
    try {
      await generateToolPdf({
        ...
        filename: "standard-deviation-calculator.pdf",
      });
      setPdfState("done");
