...
export default function LoanShareExportModal({
  ...
  const paymentLabel = t(`form.payFrequency.${paymentFrequency}`);
    ...
    mode === "bond"
      ...
      : mode === "deferred"
        ...
        : [
            ...
            { label: t("form.loanTermLabel"), value: termText },
            { label: t("form.compoundLabel"), value: compoundLabel },
            { label: t("form.payBackLabel"), value: paymentLabel },
          ];
  ...
  return (
    <>
      ...
      <div data-print-area className="hidden bg-white p-8 text-black print:block">
        ...
        <h2 className="mb-2 mt-6 text-sm font-bold text-blue-600">{scheduleTable.title}</h2>
        <table className="w-full border-collapse text-xs">
          <thead>
            <tr>
              {scheduleTable.columns.map((col) => (
