...
type TriangleShareExportModalProps = {
  inputRows: Row[];
  resultRows: Row[];
  heroLabel: string;
  heroValue: string;
...
export default function TriangleShareExportModal({ inputRows, resultRows, heroLabel, heroValue, sentence, gauge }: TriangleShareExportModalProps) {
  ...
  async function handleDownloadPdf() {
    ...
    try {
      await generateToolPdf({
        ...
        filename: "triangle-calculator.pdf",
      });
      setPdfState("done");
