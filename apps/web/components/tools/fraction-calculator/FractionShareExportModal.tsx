...
type FractionShareExportModalProps = {
  inputRows: Row[];
  resultRows: Row[];
  heroLabel: string;
  heroValue: string;
...
export default function FractionShareExportModal({ inputRows, resultRows, heroLabel, heroValue, sentence, gauge }: FractionShareExportModalProps) {
  ...
  async function handleDownloadPdf() {
    ...
    try {
      await generateToolPdf({
        ...
        filename: "fraction-calculator.pdf",
      });
      setPdfState("done");
