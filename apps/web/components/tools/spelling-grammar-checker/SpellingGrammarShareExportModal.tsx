...
type SpellingGrammarShareExportModalProps = {
  resultRows: Row[];
  heroLabel: string;
  heroValue: string;
  sentence: string;
...
export default function SpellingGrammarShareExportModal({ resultRows, heroLabel, heroValue, sentence }: SpellingGrammarShareExportModalProps) {
  const t = useTranslations("tools.spelling-grammar-checker");
  ...
  async function handleDownloadPdf() {
    ...
    try {
      await generateToolPdf({
        ...
        filename: "spelling-grammar-checker.pdf",
      });
      setPdfState("done");
