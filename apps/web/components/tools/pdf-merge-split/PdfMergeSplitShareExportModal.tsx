...
type PdfMergeSplitShareExportModalProps = {
  inputRows: Row[];
  heroLabel: string;
  heroValue: string;
  sentence: string;
...
export default function PdfMergeSplitShareExportModal({ inputRows, heroLabel, heroValue, sentence }: PdfMergeSplitShareExportModalProps) {
