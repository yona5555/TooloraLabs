          ...
          <table className="w-full min-w-[420px] border-collapse text-sm">
            <thead>
              <tr className="border-b border-current/30 text-start">
                ...
                <th className="px-3 py-2 text-start font-semibold">{t("examples.columnTip")}</th>
                <th className="px-3 py-2 text-start font-semibold">{t("examples.columnTotalPerPerson")}</th>
              </tr>
            </thead>
            <tbody>
              {exampleRows.map((row) => (
                <tr key={row.scenario} className="border-b border-current/10">
                  ...
                  <td className="px-3 py-2.5 font-mono">{row.tipAmount}</td>
                  <td className="px-3 py-2.5 font-mono font-semibold">{row.totalPerPerson}</td>
                </tr>
              ))}
            </tbody>
          </table>
