...
/** Documented US restaurant-tipping convention by service tier, applied to the same $85 bill — shown as a colored quality scale (poor→excellent) rather than a bar list, matching what this diagram is actually about. */
const BILL = 85;
const TIERS = [
