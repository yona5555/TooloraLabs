...
type IdealWeightShareExportModalProps = {
  inputRows: Row[];
  resultRows: Row[];
  heroLabel: string;
  heroValue: string;
...
export default function IdealWeightShareExportModal({ inputRows, resultRows, heroLabel, heroValue, sentence, gauge }: IdealWeightShareExportModalProps) {
  ...
  async function handleDownloadPdf() {
    ...
    try {
      await generateToolPdf({
        ...
        filename: "ideal-weight-calculator.pdf",
      });
      setPdfState("done");
