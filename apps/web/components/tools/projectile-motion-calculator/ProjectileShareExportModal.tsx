...
type ProjectileShareExportModalProps = {
...
export default function ProjectileShareExportModal({ operationLabel, inputRows, resultRows, heroLabel, heroValue, sentence, gauge }: ProjectileShareExportModalProps) {
  ...
  async function handleDownloadPdf() {
    ...
    try {
      await generateToolPdf({
        ...
        filename: "projectile-motion-calculator.pdf",
      });
      setPdfState("done");
