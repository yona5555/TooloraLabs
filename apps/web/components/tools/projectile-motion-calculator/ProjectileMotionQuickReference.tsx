...
const FORMULA_KEYS = ["timeOfFlight", "maxHeight", "range", "impactSpeed"] as const;

export default function ProjectileMotionQuickReference() {
  const t = useTranslations("tools.projectile-motion-calculator.aboveFold.quickReference");
