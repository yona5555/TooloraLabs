...
type TextLogoShareExportModalProps = {
  inputRows: Row[];
  resultRows: Row[];
  heroLabel: string;
  heroValue: string;
...
export default function TextLogoShareExportModal({ inputRows, resultRows, heroLabel, heroValue, sentence }: TextLogoShareExportModalProps) {
  const t = useTranslations("tools.text-logo-generator");
  ...
  async function handleDownloadPdf() {
    ...
    try {
      await generateToolPdf({
        ...
        filename: "text-logo-generator.pdf",
      });
      setPdfState("done");
