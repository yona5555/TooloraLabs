...
type ReadabilityShareExportModalProps = {
  inputRows: Row[];
  resultRows: Row[];
  heroLabel: string;
  heroValue: string;
...
export default function ReadabilityShareExportModal({ inputRows, resultRows, heroLabel, heroValue, sentence, gauge }: ReadabilityShareExportModalProps) {
  const t = useTranslations("tools.readability-score-calculator");
  ...
  async function handleDownloadPdf() {
    ...
    try {
      await generateToolPdf({
        ...
        filename: "readability-score-calculator.pdf",
      });
      setPdfState("done");
