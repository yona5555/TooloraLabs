...
const FORMULA_KEYS = ["fleschReadingEase", "fleschKincaidGrade"] as const;

export default function ReadabilityQuickReference() {
  const t = useTranslations("tools.readability-score-calculator.aboveFold.quickReference");
  ...
  return (
    <SectionCard title={t("title")}>
      ...
      <p className="mt-4 text-xs text-zinc-500 dark:text-zinc-400">{t("englishOnlyNote")}</p>
    </SectionCard>
  );
}
