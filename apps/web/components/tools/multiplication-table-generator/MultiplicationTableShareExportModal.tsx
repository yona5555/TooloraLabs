...
type MultiplicationTableShareExportModalProps = {
  inputRows: Row[];
  resultRows: Row[];
  heroLabel: string;
  heroValue: string;
...
export default function MultiplicationTableShareExportModal({ inputRows, resultRows, heroLabel, heroValue, sentence }: MultiplicationTableShareExportModalProps) {
  ...
  async function handleDownloadPdf() {
    ...
    try {
      await generateToolPdf({
        ...
        filename: "multiplication-table-generator.pdf",
      });
      setPdfState("done");
