...
type DiceShareExportModalProps = {
  inputRows: Row[];
  resultRows: Row[];
  heroLabel: string;
  heroValue: string;
...
export default function DiceShareExportModal({ inputRows, resultRows, heroLabel, heroValue, sentence }: DiceShareExportModalProps) {
