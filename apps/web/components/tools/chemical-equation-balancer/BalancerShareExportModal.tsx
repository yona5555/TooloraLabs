...
type BalancerShareExportModalProps = {
...
export default function BalancerShareExportModal({ operationLabel, inputRows, resultRows, heroLabel, heroValue, sentence, gauge }: BalancerShareExportModalProps) {
  ...
  async function handleDownloadPdf() {
    ...
    try {
      await generateToolPdf({
        ...
        filename: "chemical-equation-balancer.pdf",
      });
      setPdfState("done");
