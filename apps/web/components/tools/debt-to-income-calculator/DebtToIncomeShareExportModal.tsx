...
type DebtToIncomeShareExportModalProps = {
  mode: DtiMode;
  inputRows: Row[];
  resultRows: Row[];
  heroLabel: string;
...
export default function DebtToIncomeShareExportModal({ mode, inputRows, resultRows, heroLabel, heroValue, sentence }: DebtToIncomeShareExportModalProps) {
  ...
  async function handleDownloadPdf() {
    ...
    try {
      await generateToolPdf({
        ...
        filename: "debt-to-income-calculator.pdf",
      });
      setPdfState("done");
