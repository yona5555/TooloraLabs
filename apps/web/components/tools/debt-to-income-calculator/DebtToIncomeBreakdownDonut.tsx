...
type DebtToIncomeBreakdownDonutProps = {
  segments: Segment[];
  centerValue: string;
  centerLabel: string;
};
...
export default function DebtToIncomeBreakdownDonut({ segments, centerValue, centerLabel }: DebtToIncomeBreakdownDonutProps) {
