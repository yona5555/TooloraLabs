...
type ProbabilityShareExportModalProps = {
  inputRows: Row[];
  resultRows: Row[];
  heroLabel: string;
  heroValue: string;
...
export default function ProbabilityShareExportModal({ inputRows, resultRows, heroLabel, heroValue, sentence, gauge }: ProbabilityShareExportModalProps) {
  ...
  async function handleDownloadPdf() {
    ...
    try {
      await generateToolPdf({
        ...
        filename: "probability-calculator.pdf",
      });
      setPdfState("done");
