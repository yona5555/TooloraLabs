...
type StoichiometryShareExportModalProps = {
...
export default function StoichiometryShareExportModal({ operationLabel, inputRows, resultRows, heroLabel, heroValue, sentence, gauge }: StoichiometryShareExportModalProps) {
  ...
  async function handleDownloadPdf() {
    ...
    try {
      await generateToolPdf({
        ...
        filename: "stoichiometry-calculator.pdf",
      });
      setPdfState("done");
