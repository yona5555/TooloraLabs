...
import LossyLosslessDiagram from "./LossyLosslessDiagram";

type ExampleRow = { scenario: string; result: string };

export default async function ImageEducation() {
  const t = await getTranslations("tools.image-converter.education");
  ...
  return (
    <EncyclopediaPaper>
      <InfoSection title={t("intro.title")}>
        ...
        <LossyLosslessDiagram
          losslessLabel={t("intro.diagram.losslessLabel")}
          lossyLabel={t("intro.diagram.lossyLabel")}
          originalLabel={t("intro.diagram.originalLabel")}
          compressedLabel={t("intro.diagram.compressedLabel")}
          resultLabel={t("intro.diagram.resultLabel")}
          identicalLabel={t("intro.diagram.identicalLabel")}
          approximateLabel={t("intro.diagram.approximateLabel")}
