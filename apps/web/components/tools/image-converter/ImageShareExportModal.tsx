...
type ImageShareExportModalProps = {
...
export default function ImageShareExportModal({ operationLabel, inputRows, resultRows, heroLabel, heroValue, sentence }: ImageShareExportModalProps) {
