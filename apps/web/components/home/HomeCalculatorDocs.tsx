 ...
 * and not the third-column idea from the previous task. It reuses the exact
 ...
 * (already complete and verified across all 6 locales), just without that
 * page's breadcrumb/TOC/sidebar chrome, since here it's one section among
 * several on the homepage rather than a page of its own.
 */
