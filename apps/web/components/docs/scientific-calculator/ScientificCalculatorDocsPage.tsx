...
export const RELATED_TOOLS = ["step-by-step-math-solver", "graphing-calculator", "notepad-calculator", "percentage-calculator", "fraction-calculator"];

export async function getScientificCalculatorTocItems(): Promise<TocItem[]> {
...
export default async function ScientificCalculatorDocsPage() {
  const t = await getTranslations("docs.tools.scientific-calculator");
  ...
  return (
    <>
      <DocsBreadcrumb items={[{ label: tNav("overview"), href: "/docs" }, { label: tNav("toolsGuide"), href: "/docs" }, { label: tTools("scientific-calculator.title") }]} />
      <DocsHero title={tTools("scientific-calculator.title")} version={t("version")} description={t("description")} />
