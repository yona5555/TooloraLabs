...
import CalculationFlowchart from "./CalculationFlowchart";
import GrowthComparisonDiagram from "./GrowthComparisonDiagram";
import ResultAnatomyDiagram from "./ResultAnatomyDiagram";
  ...
  return (
    <>
      ...
      <DocsSection id="anatomy" title={t("sectionAnatomy")}>
        ...
        <ResultAnatomyDiagram
          labelPrincipal={t("anatomy.labelPrincipal")}
          labelContributions={t("anatomy.labelContributions")}
          labelInterest={t("anatomy.labelInterest")}
          labelTotal={t("anatomy.labelTotal")}
