...
export const RELATED_TOOLS = ["gpa-calculator", "study-time-calculator", "class-schedule-builder"];

export async function getCitationGeneratorTocItems(): Promise<TocItem[]> {
  const t = await getTranslations("docs.tools.citation-generator");
  return [
...
export default async function CitationGeneratorDocsPage() {
  const t = await getTranslations("docs.tools.citation-generator");
  ...
  return (
    <>
      <DocsBreadcrumb items={[{ label: tNav("overview"), href: "/docs" }, { label: tNav("toolsGuide"), href: "/docs" }, { label: tTools("citation-generator.title") }]} />
      <DocsHero title={tTools("citation-generator.title")} version={t("version")} description={t("description")} />
      ...
      <DocsSection id="anatomy" title={t("sectionAnatomy")}>
        ...
        <ValueComparisonBarDiagram
          bars={[
            { label: t("anatomy.labelApa"), value: 20, colorClass: "fill-blue-600 dark:fill-blue-400" },
            { label: t("anatomy.labelMla"), value: 2, colorClass: "fill-emerald-500 dark:fill-emerald-400" },
            { label: t("anatomy.labelChicago"), value: 3, colorClass: "fill-purple-500 dark:fill-purple-400" },
          ]}
